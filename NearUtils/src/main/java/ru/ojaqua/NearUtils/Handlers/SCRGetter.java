...
public class SCRGetter implements Runnable {
	...
	public void run() {
		...
		throw new UError("Тестовая ошибка Тестовая ошибка Тестовая ошибка Тестовая ошибка Тестовая ошибка Тестовая ошибка Тестовая ошибка Тестовая ошибка Тестовая ошибка Тестовая ошибка", "Доп инфа в трассе");
